...
// ... (Existing MOCK DATA and renderStyledText - Keep as is, omitted for brevity)
const KEYWORDS = [
  ...
  return (
    <section id="proactive-admin" className="relative z-10 py-24 px-4 w-full max-w-7xl mx-auto scroll-mt-24">
      ...
      >
          ...
          <button 
            onClick={() => window.open('https://ai.studio/apps/drive/1zzGfEevIBZBn6w9CrGeJiEBhbg2HrOQ6?fullscreenApplet=true', '_blank')} 
