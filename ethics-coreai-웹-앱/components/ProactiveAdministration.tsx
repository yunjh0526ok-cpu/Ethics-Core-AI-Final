      ...
      const response = await genAI.models.generateContent({
        ...
        config: {
            systemInstruction: `
                ...
                3. 특정 기관(외교부, 국토부 등)의 적극행정 사례를 질문받으면:
                   - 보유 데이터에 없더라도 "모른다"고 하지 말 것
                   - 해당 기관 공식 홈페이지 안내: 
                     예) 외교부 → www.mofa.go.kr → 정보공개 → 적극행정
                   - 인사혁신처 적극행정 포털: https://www.mpm.go.kr/proactivePublicService → 적극행정 메뉴
                   - 국민권익위원회: www.acrc.go.kr → 적극행정 사례 검색 안내
                   [주요 기관 적극행정 안내 링크]
                   - 인사혁신처 적극행정: www.mpm.go.kr
                   - 외교부: www.mofa.go.kr
                   - 행정안전부: www.mois.go.kr  
                   - 국민권익위원회: www.acrc.go.kr
                   - 각 지자체: 해당 시도 홈페이지 → 적극행정 검색
                   - 각 중앙부처는 기관 홈페이지 내 '적극행정' 또는 '정보공개' 메뉴에서 확인 가능함을 안내
                4. 모를 때만 위 공식 사이트 안내 후 "해당 기관에 직접 문의 권장"
