...
const QUIZ_DATA: Record<Category, { title: string; color: string; gradient: string; icon: React.ReactNode; questions: Question[] }> = {
  integrity: {
    ...
    questions: [
      {
        id: 1,
        text: "청탁금지법상 공직자가 받을 수 있는 음식물 가액 기준은?",
        options: ["1만원", "3만원", "5만원", "10만원"],
        correct: 1,
        explanation: "청탁금지법 시행령에 따라 음식물은 3만원, 선물은 5만원(농수산물 15만원), 경조사비는 5만원이 한도입니다."
      },
      {
        id: 2,
        text: "이해충돌방지법에서 '사적 이해관계 신고' 의무가 발생하는 경우는?",
        options: ["가족이 관련 기업에 취업한 경우", "업무 관련자와 친족 관계인 경우", "본인 소유 부동산이 업무와 관련된 경우", "위의 모두 해당"],
        correct: 3,
        explanation: "이해충돌방지법 제5조에 따라 직무 관련 사적 이해관계가 있는 경우 모두 신고 의무가 발생합니다."
      },
      {
        id: 3,
        text: "직장 내 괴롭힘으로 인정되기 위한 요건이 아닌 것은?",
        options: ["우월한 지위 또는 관계 이용", "업무상 적정 범위를 넘는 행위", "신체적·정신적 고통 유발", "반드시 상사가 부하에게 행한 행위"],
        correct: 3,
        explanation: "직장 내 괴롭힘은 동료 간, 부하에서 상사에게도 성립할 수 있습니다. 지위는 관계적 우월성을 의미합니다."
      },
      {
        id: 4,
        text: "공익신고자 보호법상 보호 대상 공익신고 기관은?",
        options: ["국민권익위원회만", "감사원과 검찰만", "행정기관·수사기관·국민권익위원회 등", "언론사 포함 모든 기관"],
        correct: 2,
        explanation: "공익신고는 행정기관, 수사기관, 국민권익위원회, 국회의원, 공익신고대리인 등에게 할 수 있습니다."
      },
      {
        id: 5,
        text: "청렴도 측정에서 '체감 청렴도'와 '인식 청렴도'의 차이는?",
        options: [
          "체감은 외부민원인, 인식은 내부직원 대상",
          "체감은 직접 경험, 인식은 전반적 평가",
          "두 개념은 동일한 의미",
          "체감은 정량, 인식은 정성 조사"
        ],
        correct: 1,
        explanation: "체감 청렴도는 실제 부패 경험 여부를, 인식 청렴도는 해당 기관의 전반적 청렴 수준에 대한 평가를 측정합니다."
      },
    ],
  },
  workshop: {
