...
import { ShieldAlert, Scale, ExternalLink, MessageCircle, ArrowRight } from 'lucide-react';
  ...
  return (
    <section className="relative z-10 py-16 px-4 w-full max-w-6xl mx-auto min-h-[50vh] flex flex-col justify-center">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
        {/* 1. ECA Corruption Counselor (Compact Version) */}
        <motion.div 
            id="corruption-frame"
        ...
        >
            ...
            <a 
                href="https://aistudio.google.com/app/shared/f1e78453716a44f0b2f155f9a6907c8c"
                target="_blank"
        ...
        {/* 2. Public Finance Recovery (Compact Version) */}
        <motion.div 
            id="recovery-frame"
            initial={{ opacity: 0, scale: 0.95 }}
            whileInView={{ opacity: 1, scale: 1 }}
