  ...
  return (
    <section 
      className={`relative w-full min-h-screen flex flex-col z-10 px-4 overflow-hidden transition-all duration-700 ease-in-out ${
        viewMode === 'intro' 
          ? 'justify-start items-center pt-24 md:pt-32' 
          : 'justify-center items-center pt-0'
      }`}
    >
      {/* Background Glow */}
      ...
      <AnimatePresence mode="wait">
        ...
        {viewMode === 'intro' && (
          ...
          >
            ...
            {/* Main Title */}
            {/* Large margin-bottom to allow the 3D Globe to appear "between" the title and subtitle */}
            <motion.h1 
              initial={{ opacity: 0, y: 30 }}
              animate={{ opacity: 1, y: 0 }}
              transition={{ duration: 0.8, delay: 0.2 }}
              className="text-5xl md:text-7xl lg:text-8xl font-black text-white leading-[1.2] mb-[32vh] tracking-tight drop-shadow-2xl break-keep"
            >
              조직의 미래를 바꾸는<br />
            ...
            <motion.p 
              ...
              className="text-xl md:text-3xl text-slate-300 font-light leading-relaxed max-w-5xl mx-auto mb-10 break-keep"
            >
            ...
            >
                ...
                <button 
                  ...
                  className="px-10 py-5 bg-gradient-to-r from-blue-600 to-cyber-purple text-white rounded-full font-black text-xl hover:shadow-[0_0_30px_rgba(37,99,235,0.6)] transition-all flex items-center justify-center gap-3 shadow-lg group relative overflow-hidden min-w-[240px] border border-white/10"
                >
                ...
                <button 
                  ...
                  className="px-10 py-5 bg-gradient-to-r from-blue-600 to-cyber-purple text-white rounded-full font-bold text-xl hover:shadow-[0_0_30px_rgba(139,92,246,0.6)] transition-all flex items-center justify-center gap-3 group min-w-[240px] border border-white/10 relative overflow-hidden"
                >
                  <span className="relative z-10 flex items-center gap-2">
        ...
        {viewMode === 'consulting' && (
          <motion.div 
            ...
            className="w-full min-h-screen flex flex-col items-center justify-center relative z-20 py-12 px-4"
          >
            {/* 
              LAYOUT CONTAINER 
              - xl:gap-[450px]: 중앙 지구본이 보이도록 충분한 간격 확보
              - w-full max-w-[1600px]: 전체 너비 확장
              - items-center justify-center: Ensures symmetry around the center axis
            */}
            <div className="flex flex-col xl:flex-row items-center justify-center gap-12 xl:gap-[450px] w-full max-w-[1600px] mb-0 relative z-10">
                ...
                >
                    ...
                    <div className="bg-gradient-to-r from-blue-600 to-cyber-purple p-8 flex items-center gap-5 relative overflow-hidden shrink-0 h-[140px]">
                        ...
                        <div className="relative z-10">
                            <h3 className="text-white font-bold text-xl">Ethics-CoreAI 파트너</h3>
                ...
                >
                    ...
                    <div className="bg-gradient-to-r from-blue-600 to-cyber-purple p-8 flex items-center gap-5 relative overflow-hidden shrink-0 h-[140px]">
                        ...
                        <div className="relative z-10">
                            <h3 className="text-white font-bold text-xl">에틱스 코어 전문 상담</h3>
      ...
      <AnimatePresence>
        {viewMode === 'consulting' && (
            <motion.button 
                ...
                // Adjusted Position: left: 44%, bottom: 12% (lower than before)
                className="fixed bottom-[12%] left-[44%] -translate-x-1/2 z-[9999] group bg-gradient-to-r from-blue-600 to-cyber-purple hover:from-blue-500 hover:to-purple-500 border border-white/20 rounded-full text-white font-black text-sm px-10 py-4 flex items-center gap-3 shadow-[0_0_30px_rgba(139,92,246,0.5)] hover:shadow-[0_0_40px_rgba(139,92,246,0.7)] transition-all duration-300 uppercase tracking-widest ring-2 ring-white/20"
            >
