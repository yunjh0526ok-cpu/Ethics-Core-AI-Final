      ...
      <AnimatePresence mode="wait">
        ...
        {viewMode === 'intro' && (
          ...
          >
            ...
            >
              조직의 미래를 바꾸는<br />
              <span className="text-transparent bg-clip-text bg-gradient-to-r from-cyber-400 via-cyber-500 to-cyber-purple">Ethics-Core AI</span>
            </motion.h1>
            ...
            >
              <span className="text-white font-bold">청렴한 AI 솔루션</span>으로<br/>
              복잡한 조직문화의 문제를 즉시 해결해드립니다.
            </motion.p>
        ...
        {viewMode === 'consulting' && (
          ...
          >
            ...
            {/* LEFT: VIDEO AGENT */}
            {/* Sized slightly smaller than the right box for balance */}
            <div className="w-full md:w-[45%] flex justify-center md:justify-end items-center p-4">
                <motion.div
                    initial={{ opacity: 0, x: -50 }}
                    animate={{ opacity: 1, x: 0 }}
                    transition={{ delay: 0.3 }}
                    className="relative w-full max-w-[380px] aspect-[9/16] rounded-[2rem] overflow-hidden shadow-[0_0_50px_rgba(6,182,212,0.15)] border border-cyber-accent/20 bg-black/40 backdrop-blur-sm"
                >
                    <video
                        ref={videoRef}
                        src="./grok-video-b917edc2-283f-4a04-a75d-e1b4ba29d92d.mp4"
                    ...
                    {/* Status Indicator */}
                    <div className="absolute top-6 left-6 px-3 py-1 bg-black/60 backdrop-blur rounded-full border border-cyber-accent/30 flex items-center gap-2">
