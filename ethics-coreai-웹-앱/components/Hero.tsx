      ...
      <AnimatePresence mode="wait">
        ...
        {viewMode === 'intro' && (
          ...
          >
            ...
            {/* Main Title */}
            {/* Adjusted: mb-[15vh] for tighter robot framing */}
            <motion.h1 
              initial={{ opacity: 0, y: 30 }}
              animate={{ opacity: 1, y: 0 }}
              transition={{ duration: 0.8, delay: 0.2 }}
              className="text-5xl md:text-7xl lg:text-8xl font-black text-white leading-[1.2] mb-[15vh] tracking-tight drop-shadow-2xl break-keep"
            >
              조직의 미래를 바꾸는<br />
            ...
            {/* Subtitle */}
            {/* Adjusted: mt-[15vh] to match symmetry */}
            <motion.p 
              initial={{ opacity: 0, y: 30 }}
              animate={{ opacity: 1, y: 0 }}
              transition={{ duration: 0.8, delay: 0.4 }}
              className="text-xl md:text-3xl text-slate-300 font-light leading-relaxed max-w-5xl mx-auto mb-10 mt-[15vh] break-keep relative z-20"
            >
            ...
            <motion.div
                ...
                className="flex flex-col sm:flex-row gap-6 mb-20 relative z-20"
            >
