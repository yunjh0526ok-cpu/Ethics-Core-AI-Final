...
import { Phone, Mail, Globe, User, ArrowRight, ArrowLeft } from 'lucide-react';
...
const Contact: React.FC = () => {
  ...
  return (
    <section id="contact" className="relative z-10 py-24 px-4 w-full max-w-7xl mx-auto min-h-screen flex flex-col justify-center">
      {/* Back Button */}
      ...
      <div className="relative rounded-[3rem] overflow-hidden border border-slate-800 bg-[#0a0a12] p-8 md:p-16 text-center shadow-2xl">
        {/* Background Effects */}
